...
@EnableMongoRepositories("hello.infrastructure.repository")
class Application {
	...
	fun init(repository: CustomerRepository) = CommandLineRunner {
		...
		log.info("Customers found with findByFirstName('Chloe'):")
		log.info("-------------------------------")
		for (customer in repository.findByLastName("Chloe")) {
			log.info(customer.toString())
		}
		log.info("")
